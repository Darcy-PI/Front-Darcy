...
export default function AmbientContainerTeacher({
  id,
  name,
  serie,
  matter,
  ...
  return (
    <div>
      ...
      <p className={styles.paragraph}>
        Para acessar mais infomações{" "}
        <Link href={`/virtualAmbientGraph/${id}`} className={styles.link}>
          Clique aqui!!
        </Link>
      </p>
    </div>
