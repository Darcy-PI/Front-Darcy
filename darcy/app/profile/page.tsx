          ...
          <div className={styles.profileBox}>
            ...
            <div className={styles.divData}>
              {profileData.id ? (
                <>
                  <p>
                    ID:<span> {profileData.id}</span>
                  </p>
                  <p>
                    Nome: <span>{profileData.userName}</span>
                  </p>
                  <p>
                    Nome Completo: <span>{profileData.completeName}</span>
                  </p>
                </>
              ) : (
            ...
            <Button type="button" onClick={disconect}>
              Desconectar
            </Button>
          </div>

          <div className={styles.editIcon}>
            <Link href="/editProfile" className={styles.link}>
              {" "}
              <FaRegEdit size={25} className={styles.image} /> Edit
            </Link>
          </div>
        </div>
      </main>
